...
> 목록에 항목이 하나도 없을 때 보고서 출력 (0)
> 
> 목록에 항목이 한 개만 있을 때 보고서 출력 (1)
> 
> 목록에 항목이 없을 때 한 항목 추가 (0 -> 1 추가)
> 
> 목록에 항목이 하나만 있을 때 한 항목 추가하기 (1 -> 1 + 1추가)
> 
> 목록에 항목이 아직 열 개 미만일 때 한 항목 추가하기 (x < 10 -> x = x+1)
> 
> 목록에 항목이 이미 열 개가 있을 때 한 항목 추가하기 (x == 10 -> x = x+1)
